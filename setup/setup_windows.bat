...
REM 複製 stop hook 腳本到 ~/.claude/scripts/
if not exist "%USERPROFILE%\.claude\scripts" mkdir "%USERPROFILE%\.claude\scripts"
copy /Y "%AGENT_DIR%\scripts\symbiont-stop-hook.sh" "%USERPROFILE%\.claude\scripts\symbiont-stop-hook.sh" >nul
echo       symbiont-stop-hook.sh 已複製
